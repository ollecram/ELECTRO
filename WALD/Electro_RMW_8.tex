...
$\dv[2]*{\vb{X}}{t}$ points orthogonally to $\dv*{\vb{X}}{t}$---as occurs for circular motion. For relativistic velocities, the radiation in this case is known as \tit{synchrotron radiation}. We further orient our axes so that $\dv[2]*{\vb{X}}{t}$ instantaneously points in the $x$-direction. Equation (\ref{eq:109}) then yields
...
Thus, in any inertial frame, the total energy radiated to infinity in that frame between retarded times $t_1$ and $t_2$ is given by
