...
%-----------------------------------------------------------------------------
	...
	\item Definisci il \tit{movimento rigido} di un vettore unitario $\vu{n}(t)$ che applicato al centro della sfera determini implicitamente una \tit{curva} $(\theta(t), \phi(t))$ nello spazio tridimensionale; 
...
%-----------------------------------------------------------------------------
	...
	%-------------------------------------------------------------------------
%-----------------------------------------------------------------------------
\item \tbi{METODO III} (variante del metodo I) 
%-----------------------------------------------------------------------------
	%-------------------------------------------------------------------------
	\begin{enumerate}[(a)]
