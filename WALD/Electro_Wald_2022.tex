...
\usepackage{mathrsfs}	% To use Script fonts in math mode using, for example \mathscr{ABCDST}
...
\include{Electro_RMW_P}   % Preface  

\include{Electro_RMW_1}   % Introduction: Electromagnetic Theory without Myths  
\include{Electro_RMW_2}   % Electrostatics
\include{Electro_RMW_3}   % Dielectrics
\include{Electro_RMW_4}   % Magnetostatics
\include{Electro_RMW_5}   % Electrodynamics
\include{Electro_RMW_6}   % Electrodynamics in Media
\include{Electro_RMW_7}   % Geometric Optics, Interference, Diffraction
\include{Electro_RMW_8}   % Special Relativity
\include{Electro_RMW_9}   % Electromagnetism as a Gauge Theory
\include{Electro_RMW_10}  % Point Charges and Self-Force
