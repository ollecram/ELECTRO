...
\title{Classical Electrodynamics, Third Edition\\
\small{Wiley, 2001}}
\maketitle
...
\include{Electro_JDJ_I}   % Introduction and Survey  
\include{Electro_JDJ_1}   % Introduction to Electrostatics  
\include{Electro_JDJ_2}   % Boundary-Value Problems in Electrostatics: I  
\include{Electro_JDJ_3}   % Boundary-Value Problems in Electrostatics: II
\include{Electro_JDJ_4}   % Multipoles, Electrostatics in Dielectric Media: II


% 1 -- Vector Analysis
%\include{Electro_JDJ_1}  % Material from J.D. Jackson Classical Electrodynamics, 3rd Edition - 
% 2 -- Electrostatics
%\include{Electro_JDJ_2}  % Material from J.D. Jackson Classical Electrodynamics, 3rd Edition - 


\appendixpage
% Appendix on Units and Dimensions
\include{Electro_JDJ_A1}  % Appendix A from J.D. Jackson Classical Electrodynamics, 3rd Edition
