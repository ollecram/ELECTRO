...
% A -- Vector Analysis
% B -- Electrostatics
\include{Electro_B1}  % THE ELECTRIC FIELD
\include{Electro_B2}  % DIVERGENCE AND CURLS OF ELECTROSTATIC FIELDS
\include{Electro_B3}  % ELECTRIC POTENTIAL 
\include{Electro_B4}  % WORK AND ENERGY IN ELECTROSTATICS
\include{Electro_B5}  % CONDUCTORS
% C -- Potentials
